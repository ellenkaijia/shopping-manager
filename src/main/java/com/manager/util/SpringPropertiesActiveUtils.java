...
import com.manager.constant.SystemEnvConstants;
...
public class SpringPropertiesActiveUtils {
	...
	/**
	 * 获取当前系统纯净环境参数runtask->run,uattask->uat.
	 * @return
	 */
	...
	public static String getCleanActiveProfiles(String activeProfiles){
		...
		}else if(isUatEnv(activeProfiles)){
			cleanEnv = SystemEnvConstants.UAT_ENV;
		...
		}else if(isDevJunitEnv(activeProfiles)){
			cleanEnv = SystemEnvConstants.DEV_JUNIT_ENV;
		}else{
	...
	public static boolean isUatEnv(){
		...
		return isConfirmEnv(SystemEnvConstants.UAT_ENV);
	}
	 ...
	 * @return
	 */
	public static boolean isUatEnv(String activeProfiles){
		
		return isConfirmEnv(activeProfiles,SystemEnvConstants.UAT_ENV);
	}
	 ...
	 * @return
	 */
	public static boolean isDevJunitEnv(){
		
		return isConfirmEnv(SystemEnvConstants.DEV_JUNIT_ENV);
	}
	 ...
	 * @return
	 */
	public static boolean isDevJunitEnv(String activeProfiles){
		
		return isConfirmEnv(activeProfiles,SystemEnvConstants.DEV_JUNIT_ENV);
	}
	 ...
	 * @return
	 */
	public static boolean isTaskEnv(){
		
		return isConfirmEnv(SystemEnvConstants.TASK_ENV);
	}
	 ...
	 * @return
	 */
	public static boolean isTaskEnv(String activeProfiles){
		
		return isConfirmEnv(activeProfiles,SystemEnvConstants.TASK_ENV);
	}
