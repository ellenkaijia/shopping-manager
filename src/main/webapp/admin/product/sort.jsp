...
<body>
	<div id="cc" class="easyui-layout"
		...
		<div
			...
			<form id="queryConditionForm">
				...
				<table cellspacing="1" cellpadding="0" class="tb_searchbar">
					<tr>
						<td style="width: 250px;"><input name="sortName"
							style="width: 200px;" placeholder="分类名称" /></td>
		...
		<div data-options="region:'center',border:false"
			...
			<div id="menuToolbar" style="height: auto" class="datagrid-toolbar">
				<global:hasPermission url="/product/addSort">
					<a href="#" class="easyui-linkbutton" iconCls="icon-add"
						plain="true" onclick="addBandDialog();">新增类别</a>
			...
			<table id="bandDatagrid" class="easyui-datagrid" title="产品列表"
				...
				<thead>
					<tr>
						<th field="sortId" width="200" align="center">类别Id</th>
						<th field="sortName" width="150" align="center">品牌名称</th>
					</tr>
				</thead>
			</table>
		</div>
		...
		<div id="dataDialog"
			...
			<form id="dataDialogForm" enctype="multipart/form-data" method="post"
				action="${ctx}/product/addSort">
				<table cellspacing="1" cellpadding="0" class="tb_searchbar">
					<tr>
						<td class="td_title" width="25%" align="right">类别名称：</td>
						<td align="left"><input name="sortName" style="width: 45%;"
							maxLength="80" class="easyui-validatebox"
							data-options="required:true" /></td>
					</tr>
					<tr>
						<td class="td_title" width="25%" align="right">类别logo：</td>
	...
	<script type="text/javascript">
		...
		cbObj = {};
		$(function() {
			$("#bandDatagrid").datagrid("options").url = "${ctx}/product/showSort";
	...
	<script type="text/javascript">
		...
		function addBandDialog() {
			...
			dialogUrl = "${ctx}/product/addSort";
			dialogMsg = "确定要添加类别？";
			dataDialog.dialog('setTitle', "添加类别");
