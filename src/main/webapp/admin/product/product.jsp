	...
	<div id="cc" class="easyui-layout"
			...
			<form id="queryConditionForm">
				...
				<table cellspacing="1" cellpadding="0" class="tb_searchbar">
					<tr>
						...
						<td class="td_title" style="width: 80px;" align="right">新品：</td>
						<td style="width: 100px;"><select name="isNew"
							style="width: 80px;">
								<option value="" selected="selected">全部</option>
								<option value="0">普通</option>
								<option value="1">新品</option>
						</select></td>
						<td class="td_title" style="width: 80px;" align="right">热搜：</td>
						<td style="width: 100px;"><select name="isHot"
							style="width: 80px;">
								<option value="" selected="selected">全部</option>
								<option value="0">普通</option>
								<option value="1">热搜</option>
						</select></td>
		...
		<div data-options="region:'center',border:false"
			...
			<table id="zcProductDatagrid" class="easyui-datagrid" title="产品列表"
				...
				<thead>
					<tr>
						<th field="prodId" width="180" align="center">产品Id</th>
