...
var from = _b6.total==0?0:_b6.pageSize*(_b6.pageNumber-1)+1;
var to = Math.min(_b6.pageSize*(_b6.pageNumber),_b6.total);
_ba=_ba.replace(/{from}/,from);
_ba=_ba.replace(/{to}/,to);
_ba=_ba.replace(/{current}/,to-from+1);
...
if(typeof(_48d.options)=="undefined"){
	return _48d;
}
