...
var from = _18.total==0?0:_18.pageSize*(_18.pageNumber-1)+1;
var to = Math.min(_18.pageSize*(_18.pageNumber),_18.total);
_1c=_1c.replace(/{from}/,from);
_1c=_1c.replace(/{to}/,to);
_1c=_1c.replace(/{current}/,to-from+1);
...
},beforePageText:"Page",afterPageText:"of {pages}",displayMsg:"Displaying {from} to {to} and {current} of {total} items",nav:{first:{iconCls:"pagination-first",handler:function(){
